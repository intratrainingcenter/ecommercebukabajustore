 <ul>
    ...
    <li>
        <a href="{{route('dashboardIndex')}}" class="waves-effect">
            ...
            <span> User <span class="badge badge-primary pull-right">8</span></span>
        </a>
    </li>
    <li class="has_sub">
    ...
    <li>
        <a href="{{route('dashboardIndex')}}" class="waves-effect">
            ...
            <span> Promo <span class="badge badge-primary pull-right">8</span></span>
        </a>
    </li>
     <li class="has_sub">
    ...
    <li class="has_sub">
     ...
     <li>
        <a href="{{route('dashboardIndex')}}" class="waves-effect">
            ...
            <span> Setting <span class="badge badge-primary pull-right">8</span></span>
        </a>
    </li>
