<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
	<form method="POST" id="payment-form"  action="{{ route('checkoutPayment') }}">
			...
			<div class="flex-w flex-t bor12 p-t-15 p-b-30">
				...
				<div class="p-t-15">
					...
					<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9 select2">
						<select class="js-select2 destinationCity" name="destinationCity">
				...
				<div class="bor8 m-b-30">
					<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="addressShipping" placeholder="Enter Your Address (explanation)"></textarea>
				</div>
			</div>
			<br>
